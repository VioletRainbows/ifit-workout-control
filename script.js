...
const hiitWorkoutPresets = {
  beginner: { title: 'Beginner HIIT', workSpeed: 5.0, workIncline: 6.0, sets: 6, runTime: 30, walkTime: 60 },
  intermediate: { title: 'Intermediate HIIT', workSpeed: 6.5, workIncline: 8.0, sets: 8, runTime: 45, walkTime: 60 },
  advanced: { title: 'Advanced HIIT', workSpeed: 8.0, workIncline: 10.0, sets: 10, runTime: 60, walkTime: 60 },
};
